...
var _BLOCKER = true;
	...
	_dataStates[1] = {
		...
		"item_creator":"scomatbarsar@gmail.com"
		}]
	};_dataStates[2] = {
		"title":"Party Items",
		"description":"",
		...
		"item_uid":"112",
		"item_name":"Cookies",
		"item_creator":"kennethbigler@gmail.com"
		}]
	};
	_dataStates[3] = {
		"title":"Party Items",
		...
		"item_uid":"113",
		"item_name":"Cheese",
		"item_creator":"zwilson7@gmail.com"
		}]
	};
...
function loadList(parseFn){
	...
	*/
	...
	if(!_BLOCKER && _dataStates[ _dataStateIndex+1 ]) _dataStateIndex++;
	parseFn(JSON.stringify(_dataStates[ _dataStateIndex ]));
}
...
function drawList(){
	...
	for(var i=0; i<items.length; i++){
		...
		var per = $("<div />",{class:"list-item-person col-sm-3"});
			...
			per.append(name);
			var pic = $("<img />",{
				src:(mem.photo_url) ? mem.photo_url : "images/orange.jpg",
...
function addItem(){
	...
	addItemToList(newItem.value,function(){
		...
		var value={item_name:newItem.value,item_uid:null,item_creator:"scomatbarsar@gmail.com"};
		if(value!=""){
			items.push(value);
			drawList();
		}
